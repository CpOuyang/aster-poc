...
^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive deposit_transaction_1412 deposit_transaction_1412.txt -c
...
^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive deposit_1412 deposit_1412.txt -c
...
^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive card_statement_1412 card_statement_1412.txt -D '\t'
...
^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive card_1412 card_1412.txt -c
...
^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive card_customer_1412 card_customer_1412.txt -c -D '\t'
fg
alter table card_customer_1412 add column Birth_Date date;
update card_customer_1412 set birth_date = _birth_date::date;
alter table card_customer_1412 drop column _birth_date;


drop table if exists loan_customer_1412;
create table loan_customer_1412 (
    Enc_Cust_Id          varchar(256),
    Enc_Acct_Id          varchar(256),
...
;
select * from loan_customer_1412 limit 20;

^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive loan_customer_1412 loan_customer_1412.txt -c
...
^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive loan_1412 loan_1412.txt -c
...
^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive merchant_profile_1412 merchant_profile_1412.txt -c
...
;
select * from risk_1412 limit 20;

^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive risk_1412 risk_1412.txt -c


-- GraphGen Results
drop table if exists GG_Cust_Cofund;
create table GG_Cust_Cofund (
    Id varchar,
    Enc_Cust_Id varchar,
    Modularity bigint
) distribute by hash(id)
;
select * from GG_Cust_Cofund limit 20;

^z
ncluster_loader -h 192.168.31.134 -U beehive -w beehive GG_Cust_Cofund GG_Cust_Cofund.csv -c --skip-rows 1



drop table if exists GG_Cust_Sequential;
create table GG_Cust_Sequential (
    Id varchar,
    Enc_Cust_Id varchar,
    Modularity bigint
) distribute by hash(id)
;
select * from GG_Cust_Sequential limit 20;
